  ...
  (
    ...
    const createStar = React.useCallback(
      (position: Point) => {
        ...
        wrapper.className = cn("mouse-sparkles-star absolute pointer-events-none z-50", className);
    ...
    const createGlowPoint = React.useCallback(
      (position: Point) => {
        ...
        glow.className = cn("mouse-sparkles-glow-point absolute pointer-events-none z-50 rounded-full", className);
        glow.style.left = `${position.x}px`;
        glow.style.top = `${position.y}px`;
        glow.style.width = '4px';
        glow.style.height = '4px';
        glow.style.backgroundColor = 'var(--mouse-sparkles-glow-rgb, #ef2ac9)';
